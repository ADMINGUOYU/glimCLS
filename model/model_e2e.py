...
from .glim_parallel import GLIM_PARALLEL
from .stage2_model import Stage2ReconstructionModel


class GLIM_Stage2_E2E(nn.Module):
    """End-to-end model combining Stage 1 (GLIM_PARALLEL) and Stage 2 (Stage2ReconstructionModel)."""
    ...
    def _load_stage1(self, checkpoint_path: str, use_align_loss: bool):
        ...
        # Create GLIM_PARALLEL instance
        hparams = checkpoint['hyper_parameters']
        stage1 = GLIM_PARALLEL(**hparams)
