#!/usr/bin/env python
"""
Calculates stage 2 text generation metrics (utility script)
-> feed me with .csv generated by predict_stage2.py
...
stage2_df: pd.DataFrame = pd.read_csv(PATH_TO_STAGE2_CSV)

# Convert to prediction dict -> low efficiency but EASY coding
inputs = stage2_df['target'].tolist()
preds = stage2_df['prediction'].tolist()
